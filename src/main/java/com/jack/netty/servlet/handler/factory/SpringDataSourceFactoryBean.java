...
public class SpringDataSourceFactoryBean extends AbstractFactoryBean {
	...
	/**
	 * Name of target bean to instrument. This should implement
	 * {@linkplain DataSource}.
	 * 
	 * @param targetName
	 *            name of bean, not null.
	 */
