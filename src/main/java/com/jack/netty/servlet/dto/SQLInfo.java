...
public class SQLInfo {
	...
	public SQLInfo(String sysCode, String sysName, String sysIPS, String dataBaseVersion, String dataSourceDetails, String updateDate, Integer active_connection_count, Integer used_connection_count,
		Long transaction_count, Integer active_thread_count, Integer running_build_count, Integer build_queue_length, List<CounterRequest> sqlDetails) {
		super();
		this.sysCode = sysCode;
		this.sysName = sysName;
		this.sysIPS = sysIPS;
